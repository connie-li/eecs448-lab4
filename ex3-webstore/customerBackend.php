<?php
	...
	echo '<html>
		...
		<body>
			<h4>EECS 448, Exercise 3: Web Store</h4>
	...
	echo '<div><table><caption>Your receipt: </caption>
		<tr><td></td><td>Quantity</td><td>Cost per each</td><td>Subtotal</td></tr>';
	// product 1
	echo '<tr><th scope="row">Product 1</th><td>', $quantP1, '</td><td>$10.00</td><td>$', $p1Subtotal, '</td></tr>';
	// product 2
	echo '<tr><th scope="row">Product 2</th><td>', $quantP2, '</td><td>$7.50</td><td>$', $p2Subtotal, '</td></tr>';
	// product 3
